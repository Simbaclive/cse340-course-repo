...
-- Updated logo_filename to match your actual files (org1.jpg, org2.png, org3.jpg)
INSERT INTO organization (name, description, contact_email, logo_filename) VALUES
('BrightFuture Builders', 'A nonprofit focused on improving community infrastructure through sustainable construction projects.', 'info@brightfuturebuilders.org', 'org1.jpg'),
('GreenHarvest Growers', 'An urban farming collective promoting food sustainability and education in local neighborhoods.', 'contact@greenharvest.org', 'org2.png'),
('UnityServe Volunteers', 'A volunteer coordination group supporting local charities and service initiatives.', 'hello@unityserve.org', 'org3.jpg');
...
(5, 2), -- Educational (Roof Patching Workshop)
(10, 2);-- Educational (Harvest Preservation Class)
...
VALUES ('Admin User', 'admin@example.com', 'YOUR_HASHED_PASSWORD_HERE', 'Admin');